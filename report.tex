...
\begin{figure}[htb]
	...
	\caption{BERTopic visualization of blog entries incorporated in Pollux. The Scatterplot shows embeddings fof each blog entry reduced to a 2-dimensional space. The summaries of the entries was used to create the embeddings.}
	\label{fig:topic_viz_2d}
\end{figure}

\begin{figure}[htb]
    \includegraphics[width=1.0\textwidth]{figures/topics_over_time.png}
    \caption{BERTopic visualization of blogs entry topics over time. The topics are based on the summaries of the entries.}
